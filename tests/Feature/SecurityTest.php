...
class SecurityTest extends TestCase
{
    ...
    public function test_voucher_id_alone_cannot_be_redeemed(): void
    {
        ...
        $this->assertNull(Booking::latest()->first()->voucher_id);
    }

    public function test_voucher_code_applies_discount_and_increments_usage(): void
    {
        $property = Property::factory()->create(['prices' => [
        ...
        // Anchor to next Monday so night_wd (500000) always applies,
        // making the 450000 assertion deterministic regardless of run day.
        $checkIn = Carbon::parse('next Monday');
        ...
        $response = $this->postJson(route('bookings.store'), [
            ...
            'check_out' => $checkIn->copy()->addDay()->format('Y-m-d'),
    ...
    public function test_property_description_script_is_stripped_on_save(): void
    {
        ...
        $property = Property::where('slug', 'xss-property')->first();
    ...
    public function test_plain_admin_cannot_assign_super_admin(): void
    {
        ...
        $superRole = Role::updateOrCreate(['slug' => 'super-admin'], ['name' => 'Super Admin']);
