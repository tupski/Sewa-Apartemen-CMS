...
return [
    ...
    */
    ...
    // Livewire hanya dipakai di admin (Flux UI). Auto-injection dinonaktifkan
    // agar halaman publik tidak menerima payload Livewire; halaman Flux tetap
    // memuat asset via @fluxScripts (forceAssetInjection melewati flag ini).
    'inject_assets' => false,
