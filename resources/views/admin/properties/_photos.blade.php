...
{{--
    ...
    Alpine.start() and the registration would never take effect (which caused
    the "isDragging/errors/existingPhotos/... is not defined" and
    "init is not defined" ReferenceErrors).
--}}
