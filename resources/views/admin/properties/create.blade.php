        ...
        <div class="flex flex-col lg:flex-row gap-6">
            ...
            <div class="flex-1 min-w-0 space-y-6">
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-100">
                    ...
                    <div class="p-6">
                        @include('admin.properties._policy', ['property' => $property ?? null, 'propertyPlaces' => collect()])
                    </div>
                </div>
                    ...
                    <div class="p-6 space-y-5">
                        ...
                        <div>
                            ...
                            <textarea name="seo[meta_description]"
                                      id="meta_description"
                                      rows="3"
                                      class="w-full px-4 py-2.5 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition">{{ old('seo.meta_description') }}</textarea>
