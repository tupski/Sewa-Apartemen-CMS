        ...
        <div class="flex items-center justify-between gap-3">
            ...
            @if($property->status === 'published')
                <a href="{{ route('properties.public.show', $property->slug) }}"
                   ...
                   class="inline-flex items-center gap-2 px-4 py-2 rounded-lg border border-gray-300 text-sm font-medium text-gray-700 hover:bg-gray-50 transition shrink-0">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14"/>
                    </svg>
                    <span class="hidden sm:inline">Lihat di Depan</span>
                </a>
            @endif
        </div>
    </div>
        ...
        <div class="flex flex-col lg:flex-row gap-6">
            ...
            <div class="flex-1 min-w-0 space-y-6">
                    ...
                    <div class="p-6 space-y-5">
                        ...
                        <div>
                            ...
                            <textarea name="description"
                                      ...
                                      class="w-full px-4 py-2.5 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition">{{ old('description', $property->description) }}</textarea>
                            @error('description')
                                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    <div class="p-6 space-y-5">
                        ...
                        <div class="pt-2">
                            <p class="text-sm font-medium text-gray-700 mb-2">
                                Pin Lokasi di Peta
                                <span class="text-xs font-normal text-gray-500 ml-1">(klik peta atau drag pin untuk memperbarui lokasi)</span>
                            </p>
                            ...
                            <div class="mt-2 flex items-center gap-2 text-xs text-gray-500">
                                ...
                                <span id="map-coords-display">
                                    @if($property->latitude && $property->longitude)
                                        Lat: {{ number_format($property->latitude, 6) }}  |  Lng: {{ number_format($property->longitude, 6) }}
                                    @else
                                        Belum ada pin — klik peta atau gunakan pencarian
                                    @endif
                                </span>
                            </div>
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-100">
                    ...
                    <div class="p-6">
                        ...
                        @include('admin.properties._unit-types', ['property' => $property])
                    </div>
                </div>
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-100">
                    ...
                    <div class="p-6">
                        @include('admin.properties._policy', ['property' => $property, 'propertyPlaces' => $propertyPlaces ?? collect()])
                    </div>
                </div>
            ...
            <div class="w-full lg:w-80 xl:w-96 shrink-0 space-y-6 lg:sticky lg:top-6 lg:self-start">
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-100">
                    ...
                    <div class="p-5">
                        @php
                            $selectedAmenities = old('amenities', $property->amenities->pluck('id')->toArray());
                        @endphp
                            ...
                            @forelse($amenities as $amenity)
                                <label class="flex items-center gap-2 p-2.5 border border-gray-200 rounded-lg hover:bg-gray-50 cursor-pointer transition">
                                    <input type="checkbox"
                                           name="amenities[]"
                                           value="{{ $amenity->id }}"
                                           {{ in_array($amenity->id, (array) $selectedAmenities) ? 'checked' : '' }}
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-100">
                    <div class="px-5 py-4 border-b border-gray-100 flex items-center gap-3">
                        ...
                        <h3 class="text-sm font-semibold text-gray-900">Info</h3>
                    </div>
...
<button type="button"
    ...
    <span class="hidden sm:inline">Update Properti</span>
</button>
