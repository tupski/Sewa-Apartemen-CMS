...
<div class="max-w-4xl mx-auto">
    ...
    <div class="mb-6">
        <div class="flex items-center gap-2 text-sm text-gray-600 mb-2">
            ...
            <span class="text-gray-900">Create Menu Item</span>
        </div>
        <h2 class="text-2xl font-bold text-gray-800">Create Menu Item</h2>
    </div>

    <!-- Form Card -->
    <div class="bg-white rounded-lg shadow-sm">
        <form method="POST" action="{{ route('admin.navigations.store') }}" data-warn-unsaved>
            @csrf
