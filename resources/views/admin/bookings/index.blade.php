                            ...
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    ...
                                    @if($booking->voucher_discount > 0)
                                        <div class="text-xs text-green-600 mt-0.5 flex items-center gap-1">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    @if($booking->status === 'pending')
                                        <span class="px-2 py-1 inline-flex items-center gap-1 text-xs leading-5 font-semibold rounded-full bg-yellow-100 text-yellow-800">
                                            <i data-lucide="clock" class="w-3 h-3"></i> Pending
                                        </span>
                                    @elseif($booking->status === 'confirmed')
                                        <span class="px-2 py-1 inline-flex items-center gap-1 text-xs leading-5 font-semibold rounded-full bg-blue-100 text-blue-800">
                                            <i data-lucide="check-square" class="w-3 h-3"></i> Confirmed
                                        </span>
                                    @elseif($booking->status === 'cancelled')
                                        <span class="px-2 py-1 inline-flex items-center gap-1 text-xs leading-5 font-semibold rounded-full bg-red-100 text-red-800">
                                            <i data-lucide="x-circle" class="w-3 h-3"></i> Cancelled
                                        </span>
                                    @elseif($booking->status === 'completed')
                                        <span class="px-2 py-1 inline-flex items-center gap-1 text-xs leading-5 font-semibold rounded-full bg-green-100 text-green-800">
