...
@section('page-title', 'Create Redirect')
...
<div class="max-w-4xl mx-auto">
    ...
    <div class="mb-6">
        <div class="flex items-center gap-2 text-sm text-gray-600 mb-2">
            <a href="{{ route('admin.redirects.index') }}" class="hover:text-gray-900">Redirects</a>
            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path>
            </svg>
            <span class="text-gray-900">Create Redirect</span>
        </div>
        <h2 class="text-2xl font-bold text-gray-800">Create Redirect</h2>
    </div>
