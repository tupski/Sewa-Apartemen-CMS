        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            @if ($properties->isNotEmpty())
                @if ($properties->count() > 3)
                        {{-- ===================== SLIDER (> 3 properties) — Alpine.js ===================== --}}
                        @php $sliderTotal = $properties->count(); @endphp
                        <div
                            x-data="{
                                total: {{ $sliderTotal }},
                                currentIndex: 0,
                                ...
                                get trackTranslate() {
                                    // Each card is (100 / visibleCount)% of the viewport wide.
                                    // The track total width = total * (100/visibleCount)% of viewport.
                                    // Shifting currentIndex cards = currentIndex * (100/visibleCount)% of viewport
                                    // = currentIndex * (100 / total)% of the track's own width.
                                    return 'translateX(-' + (this.currentIndex * 100 / this.total) + '%)';
                                },
                                get cardWidth() {
                        ...
                        >
                            ...
                            {{-- Dot navigation — inside the x-data scope so x-for / goTo() resolve correctly --}}
