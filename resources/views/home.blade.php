...
@section('content')
        ...
        <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-28">
            <div class="max-w-3xl">
                <h1 class="text-4xl md:text-6xl font-extrabold text-white leading-tight mb-4">
                    {{ $tagline ?: 'Sewa Apartemen Harian & Transit' }}
                </h1>
                @if ($description)
                ...
                <form action="{{ route('properties.public.index') }}" method="GET"
                      class="bg-white rounded-2xl shadow-xl p-4 flex flex-col md:flex-row gap-3 max-w-2xl">
                    <div class="flex-1">
                        ...
                        <input type="text" name="search" id="search" placeholder="Cari nama apartemen…"
                               ...
                               class="w-full px-4 py-3 rounded-xl border border-gray-200 focus:outline-none focus:ring-2 text-gray-900"
    ...
    <section class="py-16 md:py-20 bg-gray-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-end justify-between mb-10">
                <div>
                    <h2 class="text-3xl md:text-4xl font-bold text-gray-900">Apartemen Pilihan</h2>
                    <p class="text-gray-600 mt-2">Temukan unit terbaik untuk kebutuhan menginap Anda</p>
                </div>
            ...
            @else
                <div class="bg-white rounded-2xl shadow-sm p-12 text-center">
                    <p class="text-gray-500">Belum ada apartemen yang tersedia. Datang kembali lagi nanti!</p>
                </div>
            @endif
        </div>
    </section>
    ...
    <section class="py-16 md:py-20 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-12">
                <h2 class="text-3xl md:text-4xl font-bold text-gray-900">Kenapa Memilih Kami?</h2>
                <p class="text-gray-600 mt-2 max-w-2xl mx-auto">Kenyamanan dan kemudahan untuk setiap kebutuhan menginap Anda</p>
            </div>
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div class="text-center p-6">
                    ...
                    <h3 class="text-lg font-semibold text-gray-900 mb-2">Sewa Harian & Transit</h3>
                    <p class="text-sm text-gray-600 leading-relaxed">Fleksibel untuk menginap singkat maupun jangka panjang dengan harga bersaing.</p>
                </div>
                <div class="text-center p-6">
                    <div class="w-16 h-16 mx-auto rounded-2xl flex items-center justify-center mb-4" style="background-color: {{ $primaryColor }}18">
                    ...
                    <p class="text-sm text-gray-600 leading-relaxed">Unit terawat dengan keamanan 24 jam dan proses booking yang mudah.</p>
                </div>
                <div class="text-center p-6">
                    <div class="w-16 h-16 mx-auto rounded-2xl flex items-center justify-center mb-4" style="background-color: {{ $primaryColor }}18">
                    ...
                    <h3 class="text-lg font-semibold text-gray-900 mb-2">Harga Transparan</h3>
                    <p class="text-sm text-gray-600 leading-relaxed">Tidak ada biaya tersembunyi. Harga yang Anda lihat adalah harga yang Anda bayar.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    @if ($posts->isNotEmpty())
        <section class="py-16 md:py-20 bg-gray-50">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex items-end justify-between mb-10">
                    <div>
                        <h2 class="text-3xl md:text-4xl font-bold text-gray-900">Dari Blog</h2>
                        <p class="text-gray-600 mt-2">Tips dan informasi terbaru seputar hunian</p>
                    </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                    @foreach ($posts as $post)
                        <a href="{{ route('blog.show', $post->slug) }}" class="group bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition">
                            ...
                            <div class="p-6">
                                ...
                                <h3 class="text-lg font-semibold text-gray-900 group-hover:opacity-80 transition leading-snug">{{ $post->title }}</h3>
                                @if ($post->excerpt)
                                    <p class="text-sm text-gray-600 mt-2 leading-relaxed">{{ \Illuminate\Support\Str::limit(strip_tags($post->excerpt), 110) }}</p>
                                @endif
                            </div>
                        </a>
                    @endforeach
    ...
    <section class="py-16 md:py-20" style="background: linear-gradient(135deg, {{ $primaryColor }} 0%, {{ $secondaryColor }} 100%);">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h2 class="text-3xl md:text-4xl font-bold text-white mb-4">Siap Menemukan Hunian Ideal Anda?</h2>
            <p class="text-white/90 mb-8">Hubungi kami untuk informasi ketersediaan dan harga terbaik</p>
            <div class="flex flex-col sm:flex-row items-center justify-center gap-4">
                ...
                @if ($whatsapp)
                    <a href="https://wa.me/{{ preg_replace('/[^0-9]/', '', $whatsapp) }}" target="_blank" rel="noopener"
                       class="inline-flex items-center px-8 py-3.5 rounded-full bg-white font-semibold hover:bg-gray-100 transition">
