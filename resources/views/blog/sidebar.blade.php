<div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6 space-y-6">
    <!-- Recent Posts -->
    <div>
        <h3 class="text-lg font-semibold text-gray-800 mb-4 pb-2 border-b border-gray-200 dark:border-gray-700">Recent Posts</h3>
        <ul class="space-y-3">
    ...
    <!-- Categories -->
    <div>
        <h3 class="text-lg font-semibold text-gray-800 mb-4 pb-2 border-b border-gray-200 dark:border-gray-700">Categories</h3>
        <ul class="space-y-2">
    ...
    <!-- Tags Cloud -->
    <div>
        <h3 class="text-lg font-semibold text-gray-800 mb-4 pb-2 border-b border-gray-200 dark:border-gray-700">Tags</h3>
